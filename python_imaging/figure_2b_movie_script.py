...
options_for_figure2b = {} # should be the same as 2b and 2c
...
movie_options_for_figure_2b = {}

movie_options_for_figure_2b = {'INCLUDE_ALL_SVGs': True,
...
mf.produce_movie(save_name='figure_2b_split_ecm_with_chemotaxsis', movie_options=movie_options_for_figure_2b, image_options=options_for_figure2b)
